        ...
        <div className="p-6 bg-gray-50">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="flex flex-col items-center p-2 bg-white rounded-lg shadow-md">
              ...
              <div className="relative w-full h-96 border border-gray-300 rounded-lg overflow-hidden flex items-center justify-center">
                {cameraActive ? (
                  <div className="relative w-full h-full flex flex-col items-center justify-center bg-black">
                    ...
                    <button
                      ...
                      className="absolute bottom-6 w-16 h-16 rounded-full bg-white border-4 border-gray-300 hover:scale-110 transition-transform"
                    />
                  </div>
                ) : image ? (
                ...
                {!cameraActive && (
                  <div className="absolute inset-0 flex items-center justify-center">
                    <button
                      ...
                      className="bg-black text-white flex items-center gap-2 px-6 py-2 rounded-full shadow-md hover:bg-gray-800 transition-colors"
                    >
