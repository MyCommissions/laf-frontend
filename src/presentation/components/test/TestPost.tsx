...
const TestPostModal = ({ open, onClose, children }: PostModalProps) => {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black bg-opacity-50 font-serif">
      <div className="bg-gray-200 rounded-xl shadow-2xl w-full max-w-4xl overflow-hidden">
        ...
        <div className="flex justify-between items-center p-4 border-b border-gray-300">
          ...
          <button
            onClick={onClose}
            className=" text-gray-700 hover:bg-gray-400 p-2 rounded-full text-4xl font-bold transition-colors"
          >
            &times;
          </button>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="md:col-span-1 space-y-4">
              ...
              <div className="relative">
                ...
                <select
                  ...
                  className="w-full appearance-none px-5 pr-8 py-2 rounded-lg border border-gray-300 bg-gray-100 text-gray-700 text-center shadow-sm focus:outline-none focus:ring-2 focus:ring-black focus:border-transparent transition-all duration-200"
                >
                  {itemSizes.map((itemSizes) => (
                    <option key={itemSizes} value={itemSizes}>
                      {itemSizes}
                    </option>
                  ))}
                </select>
            ...
            <div className="flex flex-col space-y-5">
              <div className="md:col-span-1 flex flex-col space-y-4">
                ...
                <div className="pt-6">
                  <button className="bg-black text-white w-full p-14 rounded-lg font-bold shadow-md transition-colors hover:bg-gray-800 text-lg">
                    POST
                  </button>
                </div>
              </div>
