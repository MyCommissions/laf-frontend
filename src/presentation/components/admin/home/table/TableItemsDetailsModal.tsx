...
import TableItemEditModal from "./TableItemEditModal"; // ✅ Import edit modal

interface ItemDetailsModalProps {
  item: Item | null;
  onClose: () => void;
  onDelete?: (id: string) => void;
  onUpdate?: (updatedItem: Item) => void; // ✅ For updating parent data after edit
}
...
const TableItemDetailsModal: React.FC<ItemDetailsModalProps> = ({
  ...
  return (
    <>
      {/* 🧩 Main Details Modal */}
      <div className="fixed inset-0 z-40 flex items-center justify-center bg-black bg-opacity-50 font-sans">
